...
Device::Device(Instance* instance, VkPhysicalDevice vkPhysicalDevice, VkDevice vkDevice, Queues queues)
  : instance(instance), vkPhysicalDevice(vkPhysicalDevice), vkDevice(vkDevice), queues(queues) {
}
